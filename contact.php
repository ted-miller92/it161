...
<html lang="en">
 <head>
  <title>Contact Ted Miller</title>
 ...
 <body>
     ...
     <nav class="topnav" id="myTopnav">
        ...
        <a href="contact.php">Contact Ted</a>
   ...
   <div class="wrapper">
	...
	?>  
     <footer>
      <p><small>&copy; 2021 by <a href="contact.php">Ted Miller</a>, All Rights Reserved ~ <a href="https://validator.w3.org/check/referer" target="_blank">Valid HTML</a> ~ <a href="https://jigsaw.w3.org/css-validator/check?uri=referer" target="_blank">Valid CSS</a></small></p>
    </footer>
  </div>
